    ...
    <div class="sidebar-scroll">
        <div class="user-account">
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-right account">
                    <li><a href="{{ route('users.show',auth()->user()->id) }}"><i class="fa-solid fa-user"></i> My Profile</a></li>
        ...
        <nav id="left-sidebar-nav" class="sidebar-nav">
            <ul id="main-menu" class="metismenu">
                <li class="{{ Request::routeIs('home') ? 'active' : '' }}"><a href="{{ route('home') }}"><i class="fa-solid fa-house-chimney"></i><span>Dashboard</span></a>
                </li>
                <li class="{{ Request::routeIs('users.*') || Request::routeIs('roles.*') ? 'active' : '' }}">
                    <a href="#uiElements" class="has-arrow"><i class="fa-solid fa-user"></i><span>Employee</span></a>
                    <ul>
                ...
                <li class="{{ Request::routeIs('class-routine.*') || Request::routeIs('class-routine.*') ? 'active' : '' }}">
                    <a href="#uiElements" class="has-arrow"><i class="fa-solid fa-book-open"></i><span>Class Routine</span></a>
                    <ul>
                ...
                <li class="{{ Request::routeIs('fees-type.*') || Request::routeIs('fees.*') || Request::routeIs('expense-type.*') || Request::routeIs('expense.*') ? 'active' : '' }}">
                    <a href="#uiElements" class="has-arrow"><i class="fa-solid fa-calculator"></i><span>Accounting</span></a>
                    <ul>
