@extends('layouts.backend.app',['pageTitle'=>'Users Details'])
                            ...
                            <div class="user_div">
                                @if ($user->profile_picture)
                                    <img src="{{ asset('storage/images/users/' . $user->profile_picture) }}"
                                        class="user-photo" alt="User Profile Picture" style="width: 140px;height:140px">
                                @else
                    ...
                    <blockquote class="blockquote mb-0">
                        ...
                        <div class="row profile_state text-info mt-5">
                            ...
                            <div class="col-lg-4 col-md-6">
                                ...
                                <span><a href="{{ asset('storage/images/users/' . $user->resume) }}" target="_blank">Click
                                        here</a></span>
                            </div>
                            <div class="col-lg-4 col-md-6">
                                <i class="fa fa-file-text"></i>
                                ...
                                <span><a href="{{ asset('storage/images/users/' . $user->joining_letter) }}"
