                                ...
                                <div class="input-group">
                                    ...
                                    <select class="custom-select form-control" name="department_id">
                                        ...
                                        @foreach ($department as $item)
                                            <option class="bg-dark text-white" value="{{ $item->id }}" {{ $user->department_id == $item->id ? 'selected' : '' }}>
                                                {{ $item->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <select class="custom-select form-control" name="gender">
                                        <option class="bg-dark text-white" selected value="">Choose...</option>
                                        <option class="bg-dark text-white" value="Male" {{ $user->gender == 'Male' ? 'selected' : '' }}>Male</option>
                                        <option class="bg-dark text-white" value="Female" {{ $user->gender == 'Female' ? 'selected' : '' }}>Female</option>
                                        <option class="bg-dark text-white" value="Others" {{ $user->gender == 'Others' ? 'selected' : '' }}>Others</option>
                                    </select>
                                </div>
                                @error('gender')
                                    <small class="text-warning"><strong>{{ $message }}</strong></small>
