        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-6">
                            <h5 class="text-success"><strong>Edit Exam Schedule</strong></h5>
                        </div>
                        <div class="col-md-6">
                ...
                <div class="card-body">
                    <form action="{{ route('exam-schedule.update',$data->id) }}" method="post">
                        @csrf
                        @method("PUT")
                        <div class="row">
                            <!-- ==================== Exam ==================== -->
                                ...
                                <div class="input-group">
                                    ...
                                    <select class="custom-select form-control" name="exam_id">
                                        ...
                                        @foreach ($exam as $item)
                                            <option class="bg-dark text-white" value="{{ $item->id }}" {{ $data->exam_id == $item->id ? 'selected' : '' }}>
                                                {{ $item->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control date" name="exam_date" id="exam_date"
                                        placeholder="dd/mm/yyyy" value="{{ $data->exam_date }}">
                                </div>
                                @error('exam_date')
                                    <small class="text-warning"><strong>{{ $message }}</strong></small>
                                @enderror
                                ...
                                <div class="input-group">
                                    ...
                                    <select class="custom-select form-control" name="class_id" id="class_id">
                                        ...
                                        @foreach ($class as $item)
                                            <option class="bg-dark text-white" value="{{ $item->id }}" {{ $data->class_id == $item->id ? 'selected' : '' }}>
                                ...
                                <div class="input-group">
                                    ...
                                    <select class="custom-select form-control" name="class_room_id">
                                        ...
                                        @foreach ($class_room as $item)
                                            <option class="bg-dark text-white" value="{{ $item->id }}" {{ $data->class_room_id == $item->id ? 'selected' : '' }}>
                                                {{ $item->room_no }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="start_time" id="start_time"
                                        placeholder="10:30 AM" value="{{ $data->start_time }}">
                                </div>
                                @error('start_time')
                                    <small class="text-warning"><strong>{{ $message }}</strong></small>
                                @enderror
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control " name="end_time" id="end_time"
                                        placeholder="01:00 PM" value="{{ $data->end_time }}">
                                </div>
                                @error('end_time')
                                    <small class="text-warning"><strong>{{ $message }}</strong></small>
                                @enderror
